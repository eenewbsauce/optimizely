    ...
    return new Promise((resolve, reject) => {
        request({
            ...
            if (err || !body.succeeded) {
                ...
                client.setex('access-token', 7200, body.access_token, redis.print);
                client.setex('refresh-token', 7200, body.refresh_token, redis.print);
    ...
    return new Promise((resolve, reject) => {
        request({
            ...
            if (err || res.statusCode !== 200) {
                ...
                this.accessToken = body.access_token;
                client.setex('access-token', 7200, this.accessToken, redis.print);
